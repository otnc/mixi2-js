      ...
      sidebar: [
        {
          ...
          items: [
            ...
            { label: "コミュニティプラグイン", slug: "guides/plugin" },
        ...
        },
        {
          ...
          items: [
            ...
            { label: "CommunityFilter", slug: "helpers/community-filter" },
            { label: "MemberEventRouter", slug: "helpers/member-event-router" },
            { label: "PluginManagedRouter", slug: "helpers/plugin-managed-router" },
            { label: "MemberListPager", slug: "helpers/member-list-pager" },
            { label: "ApplicationPager", slug: "helpers/application-pager" },
          ],
        },
      ],
    }),
