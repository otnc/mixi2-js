...
<Tabs>
  <TabItem label="npm">
    ```typescript // ESM import {PostBuilder} from 'mixi2-js/helpers'; // CJS const {PostBuilder} =
    require('mixi2-js/helpers'); ```
  </TabItem>
  <TabItem label="JSR">
    ```typescript import {PostBuilder} from '@otoneko1102/mixi2-js/helpers'; ```
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="npm">```typescript import {PostBuilder} from 'mixi2-js/helpers'; ```</TabItem>
  <TabItem label="JSR">
    ```typescript import {PostBuilder} from '@otoneko1102/mixi2-js/helpers'; ```
  </TabItem>
</Tabs>
