...
<Tabs>
  ...
  <TabItem label="JSR">
    ```typescript
    import { EventLogger } from '@otoneko1102/mixi2-js/helpers';
    ```
  </TabItem>
</Tabs>
...
<Aside type="note">
`EventLogger` は SDK 独自の拡張機能であり、公式 API 仕様には含まれません。公式の仕様については [mixi2 Developer Platform](https://developer.mixi.social/docs) を参照してください。
</Aside>
