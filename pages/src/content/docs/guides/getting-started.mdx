...
<Tabs>
  <TabItem label="npm">```bash npm install mixi2-js ```</TabItem>
  <TabItem label="JSR">```bash npx jsr add @otoneko1102/mixi2-js ```</TabItem>
</Tabs>
...
<Tabs>
  <TabItem label="npm">
    ```typescript // ESM import {OAuth2Authenticator} from 'mixi2-js'; // CJS const{" "}
    {OAuth2Authenticator} = require('mixi2-js'); ```
  </TabItem>
  <TabItem label="JSR">
    ```typescript import {OAuth2Authenticator} from '@otoneko1102/mixi2-js'; ```
  </TabItem>
</Tabs>
